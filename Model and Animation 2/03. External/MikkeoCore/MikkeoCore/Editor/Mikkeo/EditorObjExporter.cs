...
public class EditorObjExporter : ScriptableObject {
	...
	[MenuItem ("Mikkeo/Export Mesh/Export all MeshFilters in selection to separate OBJs")]
	...
	[MenuItem ("Mikkeo/Export Mesh/Export whole selection to single OBJ")]
	static void ExportWholeSelectionToSingle () {
		...
		if (exportedObjects > 0) {
			...
			string filename = EditorSceneManager.GetActiveScene () + "_" + exportedObjects;
	...
	[MenuItem ("Mikkeo/Export Mesh/Export each selected to single OBJ")]
